...
CF_EXPORT NSString *const kCXAPIPageNumberKeyPageSize;     /// pageSize
CF_EXPORT NSString *const kCXAPIPageNumberKeyPageIndex;   /// pageIndex
CF_EXPORT const NSInteger kCXAPIDefaultPageSize;
...
@interface CXBasePageAPI : CXBaseAPI
//================================================
//                业务子类可重载方法
//================================================
/** required
...
/** optional
 页面请求条数key，默认kCXAPIPageNumberKeyPageSize
