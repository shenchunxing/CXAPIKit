...
@interface CXBatchAPIRequest : NSObject<CXAPIProtocol>
{
    @package;
    BOOL _canceled;
}
...
/* 批量请求集合 */
@property (nonatomic, strong, readonly) NSMutableSet<CXBaseAPI *> *apisSet;
...
/**
 ...
 所有api请求成功，才会调用此回调
 */
@property (nonatomic, strong) void(^requestSuccessHandler)(CXBatchAPIRequest *request);
...
/**
 ...
 任意api请求失败，就会调用此回调
 */
@property (nonatomic, strong) void(^requestFailureHandler)(CXBatchAPIRequest *request, NSError *error);
